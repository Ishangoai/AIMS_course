...
from dagster.ml_fraud.gradio_app import fraud_detection_app
...
app = FastAPI(
    ...
    6. [**Credit Card Fraud Detection App**](/fraud-detection/)
    -----
    """),
    version="1.0.0",
...
gr.mount_gradio_app(app, fraud_detection_app, path="/fraud-detection")
