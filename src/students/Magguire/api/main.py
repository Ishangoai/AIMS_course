...
from agents.gradio_app import llm_app
...
app = FastAPI(
    ...
    4. [**Fraud Detection App**](/fraud-app/)
    5. [**Report Generator App**](/report-generator-app/)
    -----
    """),
    version="1.0.0",
...
gr.mount_gradio_app(app, llm_app, path='/report-generator-app')
