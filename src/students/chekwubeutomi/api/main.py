...
from gradioapp.text_operator_assignment import app as text_operator
...
app = FastAPI(
    ...
    4. [**Text Operator Assignment**](/text-operator/)
    -----
    """),
    version="1.0.0",
...
gr.mount_gradio_app(app, text_operator, path="/text-operator")
