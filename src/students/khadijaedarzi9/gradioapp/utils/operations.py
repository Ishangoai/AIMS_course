...
class SpellChecker:
    ...
    def __init__(self) -> None:
        ...
        self.corrections: Dict[str, str] = {
            ...
            'havent': "haven't", 'hadnt': "hadn't", 'wasnt': "wasn't",
            'werent': "weren't", 'thats': "that's", 'whats': "what's",
            'hes': "he's", 'shes': "she's", 'its': "it's",
            'theyre': "they're", 'youre': "you're", 'were': "we're",
            'ive': "I've", 'youve': "you've", 'theyve': "they've",
            'weve': "we've", 'im': "I'm", 'id': "I'd", 'youd': "you'd",
            'hed': "he'd", 'shed': "she'd", 'theyd': "they'd",
            'wed': "we'd", 'ill': "I'll", 'youll': "you'll",
            'hell': "he'll", 'shell': "she'll", 'theyll': "they'll",
            'well': "we'll", 'payed': 'paid', 'mispell': 'misspell',
            'greatful': 'grateful', 'unfortunatly': 'unfortunately',
            'neccessary': 'necessary', 'occassion': 'occasion',
            'accross': 'across', 'adress': 'address',
            'arguement': 'argument', 'basicly': 'basically',
            'beleive': 'believe', 'buisness': 'business',
            'calender': 'calendar', 'catagory': 'category',
            'cemetary': 'cemetery', 'changable': 'changeable',
            'collegue': 'colleague', 'comming': 'coming',
            'committment': 'commitment', 'concious': 'conscious',
            'coperate': 'cooperate', 'critisism': 'criticism',
            'developement': 'development', 'dissapear': 'disappear',
            'embarass': 'embarrass', 'enviroment': 'environment',
            'existance': 'existence', 'fourty': 'forty',
            ...
            'rythm': 'rhythm', 'shedule': 'schedule',
            'succesful': 'successful', 'supress': 'suppress',
            'temperture': 'temperature', 'tommorrow': 'tomorrow',
            'truely': 'truly', 'useable': 'usable',
            'vaccuum': 'vacuum', 'visable': 'visible',
            'wensday': 'wednesday', 'whereever': 'wherever',
...
class TextCorrector:
    ...
    def correct(self, text: str) -> str:
        ...
        words = text.split()
        corrected_words = [self.spell_checker.fix_word(word)
                           for word in words]
