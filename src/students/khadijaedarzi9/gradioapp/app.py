...
class TextStyler:
    ...
    def apply_style(text: str, font: str, size: str, text_type: str) -> str:
        ...
        Args:
            ...
            size: The font size.
            text_type: The type of text (Title, Subtitle, Body).

        Returns:
            HTML string with styled text.
        """
        if not text:
            return ""

        font_family = TextStyler.FONT_FAMILIES.get(
...
def build_interface() -> gr.Blocks:  # noqa: C901
        ...
        with gr.Tabs():
            with gr.Tab("Correction"):
                ...
                with gr.Row():
                    with gr.Column():
                        input_text = gr.Textbox(
                            ...
                            lines=10,
                            placeholder="Start typing... text will be "
                            "corrected and styled automatically",
                        )
                        reset_btn = gr.Button("Reset", size="lg")

                    with gr.Column():
                        corrected = gr.HTML(
                            value="<div style='padding: 15px; "
                            "min-height: 300px; "
                ...
                def handle_live_correction(
                    ...
                    Args:
                        ...
                        font: Font family.
                        size: Font size.
                        text_type_val: Type of text.

                    Returns:
                        Tuple of (styled HTML, plain corrected text).
                    """
                ...
                def reset_fields() -> Tuple[str, str, str]:
                    ...
                    Returns:
                        Tuple of empty strings for all fields.
                    """
                    empty_html = (
                        "<div style='padding: 15px; min-height: 300px; "
                        "border: 1px solid #ddd; border-radius: 8px; "
            ...
            with gr.Tab("Converter"):
                ...
                def handle_conversion(
                    ...
                    if not corrected_text:
                        return "Please correct text in the Correction " \
                               "tab first."
            ...
            with gr.Tab("Reverser"):
                ...
                def handle_reversal(
                    ...
                    Returns:
                        Reversed text or error message.
                    """
                    if not corrected_text:
                        return "Please correct text in the Correction " \
                               "tab first."
            ...
            with gr.Tab("Download"):
                ...
                with gr.Row():
                    with gr.Column(scale=2):
                        format_choice = gr.Radio(
                            label="Choose your export format:",
                            choices=["TXT", "PDF"],
                            value="TXT",
                            interactive=True
                        )
                ...
                def handle_download(
                    ...
                    Args:
                        ...
                        conv_text: Converted text.
                        rev_text: Reversed text.
                        analysis_text: Analysis results.
                        format_selected: Selected format (TXT or PDF).
                    ...
                    if not corrected_text:
                        from operations import FileExporter
                        error_path = FileExporter._get_filename(fmt)
                        error_msg = (
                            "ERROR: No content to export.\n"
                            "Please correct text first in the "
                            "Correction tab."
                        )
                    ...
                    aggregated = (
                        ...
                        f"{'-' * 70}\n\n{analysis_val}\n\n\n"
                        f"{'=' * 70}\n"
                        f"End of document - Generated by Smart Text "
                        f"Studio\n"
                        f"{'=' * 70}\n"
                    )
