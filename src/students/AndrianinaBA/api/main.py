...
from text_analyzer_app import text_analyzer_app_instance  # IGNORE
...
app = FastAPI(
    ...
    4. [**Text analyzer by Vicent and Andrianina**](/text-analyzer/)
    -----
    """),
    version="1.0.0",
...
gr.mount_gradio_app(app, text_analyzer_app_instance, path="/text-analyzer")
