...
from gradioapp.fraud import app as fraud_app
...
app = FastAPI(
    ...
    4. [**Image Editing App**](/image_app/)
    5. [**Fraud Detection App**](/fraud_app/)
    -----
    """),
    version="1.0.0",
...
gr.mount_gradio_app(app, image_app, path="/image_app")
gr.mount_gradio_app(app, fraud_app, path="/fraud_app")
