...
def main():
    ...
    print("This is a very long print statement that goes beyond the recommended line length by ",
          "PEP 8 and should be split into multiple lines using backslashes or parentheses")
...
def long_line_func_0():
    print("this line is also overly long and should not be written this way but it's here"
