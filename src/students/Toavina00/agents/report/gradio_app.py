...
def llm_call(topic: str, temperature: float, outline: str):
...
with gr.Blocks(css=custom_css) as iface:
    ...
    with gr.Row():
        ...
        with gr.Column(scale=1):
            ...
            temp_display = gr.HTML(
                value='<div id="temp-display" class="moderate" style="font-size: 0.85rem; padding: 0.5rem; text-align: center;">🌤️ 0.7°</div>'  # noqa: E501
            )
    with gr.Row():
        with gr.Column():
            result = gr.Textbox(
    ...
    def update_temp_display(temp_value):
        ...
        return f'<div id="temp-display" class="{css_class}" style="font-size: 0.85rem; padding: 0.5rem; text-align: center;">{emoji} {temp_value:.1f}°</div>'  # noqa: E501
