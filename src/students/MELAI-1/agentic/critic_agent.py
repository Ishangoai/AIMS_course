...
- Verify each section has appropriate content""",
    ...
    def perform_single_revision(self, draft: str, strategy_info: Dict, 
...
IMPORTANT: Aim for exactly {TARGET_WORD_COUNT} words (Â±50 words acceptable)."""
    ...
    def revise_until_valid(self, draft: str) -> Dict:
        ...
        while revision_count < MAX_REVISION_ROUNDS:
            ...
            # Perform revision
            current_draft = self.perform_single_revision(
                current_draft, 
                strategy_info, 
                revision_count
            )
    ...
    def revise_if_needed(self, draft: str, word_count: int, structure_valid: bool,
                         revision_count: int) -> Dict:
