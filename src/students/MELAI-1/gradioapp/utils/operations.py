...
class SpellChecker:
    ...
    def __init__(self):
        self.corrections = {
            'teh': 'the', 'hw': 'how', 'r': 'are', 'u': 'you',
            'ur': 'your', 'wat': 'what', 'waht': 'what', 'wht': 'what',
            'thier': 'their', 'recieve': 'receive', 'occured': 'occurred',
            'seperate': 'separate', 'definately': 'definitely',
            'wierd': 'weird', 'freind': 'friend', 'untill': 'until',
            'begining': 'beginning', 'goverment': 'government',
            'wich': 'which', 'realy': 'really', 'alot': 'a lot',
            'dont': "don't", 'doesnt': "doesn't", 'cant': "can't",
            'wont': "won't", 'shouldnt': "shouldn't", 'wouldnt': "wouldn't",
            'couldnt': "couldn't", 'isnt': "isn't", 'arent': "aren't",
            'hasnt': "hasn't", 'havent': "haven't", 'hadnt': "hadn't",
            'wasnt': "wasn't", 'werent': "weren't",
            'thats': "that's", 'whats': "what's", 'hes': "he's",
            'shes': "she's", 'its': "it's", 'theyre': "they're",
            'youre': "you're", 'were': "we're", 'ive': "I've",
            'youve': "you've", 'theyve': "they've", 'weve': "we've",
            'im': "I'm", 'id': "I'd", 'youd': "you'd", 'hed': "he'd",
            'shed': "she'd", 'theyd': "they'd", 'wed': "we'd",
            'ill': "I'll", 'youll': "you'll", 'hell': "he'll",
            'shell': "she'll", 'theyll': "they'll", 'well': "we'll",
            'payed': 'paid', 'mispell': 'misspell',
            'greatful': 'grateful', 'unfortunatly': 'unfortunately',
            'neccessary': 'necessary', 'occassion': 'occasion',
            'accross': 'across', 'adress': 'address', 'arguement': 'argument',
            'basicly': 'basically', 'beleive': 'believe', 'buisness': 'business',
            'calender': 'calendar', 'catagory': 'category', 'cemetary': 'cemetery',
            'changable': 'changeable', 'collegue': 'colleague',
            'comming': 'coming', 'committment': 'commitment',
            'concious': 'conscious', 'coperate': 'cooperate',
            'critisism': 'criticism', 'developement': 'development',
            'dissapear': 'disappear', 'embarass': 'embarrass',
            'enviroment': 'environment', 'existance': 'existence',
            'fourty': 'forty', 'harrass': 'harass', 'humourous': 'humorous',
            'independant': 'independent', 'jewellery': 'jewelry',
            'liason': 'liaison', 'maintainance': 'maintenance',
            'occurance': 'occurrence', 'persue': 'pursue',
            'possesion': 'possession', 'prefered': 'preferred',
            'priviledge': 'privilege', 'profesional': 'professional',
            'publically': 'publicly', 'reccomend': 'recommend',
            'refered': 'referred', 'relevent': 'relevant',
            'rythm': 'rhythm', 'shedule': 'schedule', 'succesful': 'successful',
            'supress': 'suppress', 'temperture': 'temperature',
            'tommorrow': 'tomorrow', 'truely': 'truly',
            'useable': 'usable', 'vaccuum': 'vacuum',
            'visable': 'visible', 'wensday': 'wednesday', 'whereever': 'wherever',
...
class TextCorrector:
    ...
    def correct(self, text):
        ...
        corrected_words = []
        for word in words:
            corrected_word = self.spell_checker.fix_word(word)
    ...
    def generate(text):
        ...
        for idx, (word, count) in enumerate(top_words):
            ...
            style = (f'font-size: {font_size}px; color: {color}; '
                    f'margin: 5px; display: inline-block; font-weight: bold; '
...
def reverse_text(text, mode="words"):
